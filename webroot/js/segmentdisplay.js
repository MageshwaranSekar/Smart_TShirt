...
function SegmentDisplay(displayId, choice) {
	...
	this.displayAngle	= 6;
	this.digitHeight	= 20.5;
	this.digitWidth		= 12;
	this.digitDistance	= 2.5;
	this.segmentWidth	= 1.6;
...
var display = new SegmentDisplay("display", 0);
var display2 = new SegmentDisplay("display2", 0);
var display3 = new SegmentDisplay("display3", 0);
var display4= new SegmentDisplay("display4", 1);


function disp(value, displayvar) {
	displayvar.setValue(value);
}

function getGroupNumber(){
	return window.thisgroup;
}
